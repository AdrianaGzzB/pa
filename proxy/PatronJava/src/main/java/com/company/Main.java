...
public class Main {
    ...
    private static void testProxy() {
        ...
        try {
            internet.conectTo("udemy.com");
            internet.conectTo("facebook.com");
        }catch (Exception e){
    ...
    private static void testComposite() {
        CuentaComponent cuentaCorriente = new CuentaCorriente(1000.0, "Adriana");
        CuentaComponent cuentaAhorro= new CuentaAhorro(20000.0, "Adriana");
